...
----------------------------------------------------------
-Compatibility:
NOTE: Disable the folders gamedata/textures and gamedata/configs/items/items in the original mod.
...
In both cases you can now also find (rarely) artefact powders.
